...
const sections = [
  {
    ...
    body: [
      "Through 2019, as protests began to intensify, Hong Kong’s economy slowed sharply and entered its first recession in a decade. Additionally, according to a research paper, the long period of protest made real GDP per capita significantly decrease, a decline larger than some other past crises.",
      ...
      "One of the reasons for such a sharp decline in GDP was a significant drop in tourism; arrivals in August 2019 went down 40% year-on-year. Total retail sales also declined the sharpest since 1998, with a double-digit fall in some quarters of 2019.",
      "Long-term economic impact includes capital flight, which could reach almost $76 billion by 2025 as individuals seek to move to other locations. This analysis by Bank of America focused on the migration of private clients in relation to political uncertainties. Even after the protests, Hong Kong faced slower economic normalization, with tourism and retail taking time to fully recover.",
    ],
  ...
  },
  {
    ...
    pullQuote: "The figure above presents findings from a study on expressive suppression among participants in the 2019 Hong Kong protests.",
  ...
  },
  {
    ...
    body: [
      "The protests produced major political and legal consequences that resulted in a significant reduction of autonomy. Chief Executive Carrie Lam, despite massive opposition, pushed for the 2019 Fugitive Offenders bill and refused to engage with protesters. After months of demonstrations, the bill was formally withdrawn in September 2019.",
      "However, the protests led to the introduction of stronger government control. Authorities introduced emergency measures such as a face mask ban to limit anonymous demonstration. Long-term, the political system shifted toward mainland China’s control through the National Security Law, which criminalized secession, subversion, and collusion.",
      "The disqualification of democratic candidates from legislative elections further limited political opposition. Altogether, the protests led to a major reconstruction of Hong Kong’s political and legal institutions, strengthening central state authority and diminishing democratic opposition.",
    ],
